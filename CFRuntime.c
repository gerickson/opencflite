...
static CFBundleRef RegisterCoreFoundationBundle(void) {
    ...
    wchar_t *DLLFileName = (wchar_t *)L"CFLite_debug.dll"; //L"CoreFoundation_debug.dll";
#else
    wchar_t *DLLFileName = (wchar_t *)L"CFLite.dll"; //L"CoreFoundation.dll";
#endif
    ...
    CFURLRef bundleURL = CFURLCreateCopyAppendingPathComponent(kCFAllocatorSystemDefault, dllURL, CFSTR("CFLite.resources"), TRUE);
    CFRelease(fsPath);
    CFRelease(dllURL);
